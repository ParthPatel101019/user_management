...
def create_event_links(event_id: UUID, request: Request) -> list:
    return [
        {"rel": "self", "href": request.url_for("get_event", event_id=event_id)},
        {"rel": "update", "href": request.url_for("update_event", event_id=event_id)},
        {"rel": "delete", "href": request.url_for("delete_event", event_id=event_id)},
        {"rel": "publish", "href": request.url_for("publish_event", event_id=event_id)},
        {
            "rel": "unpublish",
        ...
        },
        {
            ...
            "href": request.url_for(
                "get_user", user_id=request.path_params["creator_id"]
            ),
        },
    ]
